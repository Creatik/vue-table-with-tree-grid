<template lang="html">
  <div v-if="columns.length > 0" ref="table" :class="[prefixCls, tableClass]">
    <div
      v-show="showHeader"
      ref="header-wrapper"
    ...
    >
      <table-header ref="table-header"> </table-header>
    </div>
    <div
      ref="body-wrapper"
    ...
    >
      <table-body ref="table-body" :class="bodyClass"> </table-body>
    </div>
    <div
    ...
    >
      <table-footer ref="table-footer"> </table-footer>
    </div>
  </div>
</template>
